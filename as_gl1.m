function [x,r,inform] = as_gl1(A, b, lambda, opts, inform)
...
%   where Ax=b.
%
%   AS_GL1(A,B,b,LAM,OPTS) specifies options that can be set using
%   AS_SETPARMS.
%
%   AS_GL1(A,B,LAM,OPTS,INFORM) uses information stored in INFORM
%   (from a previous call to AS_GL1) to warm-start the algorithm. Note
%   that the previous call to AS_GL1 must have been to a problem with
%   the same input parameters A,B,b.
%
%   Inputs
