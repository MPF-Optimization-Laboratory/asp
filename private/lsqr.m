...
%          || (0)     (damp I)  ||2
% A  is an m by n matrix or a function handle that points to a
% function y = A( x, mode ), where
%   y = Ax  if  mode == 1;
%   y = A'x if  mode == 2.
...
% 14 Aug 2008: Finally, A can be a matrix or a function handle.
%-----------------------------------------------------------------------

%     Initialize.
operator = isa(A,'function_handle');
